...
export const selectVisitHistory = (state: RootState) =>
  selectProfileState(state).visitHistory
export const selectPersonalOffers = (state: RootState) =>
  selectProfileState(state).personalOffers
