...
export const selectArticles = (state: RootState) => selectArticlesState(state).items
export const selectArticlesLoading = (state: RootState) => selectArticlesState(state).isLoading
export const selectArticlesError = (state: RootState) => selectArticlesState(state).error
