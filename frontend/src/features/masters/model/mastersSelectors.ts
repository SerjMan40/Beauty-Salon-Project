...
export const selectMasters = (state: RootState) =>
  selectMastersState(state).items
export const selectMastersLoading = (state: RootState) =>
  selectMastersState(state).isLoading
export const selectMastersError = (state: RootState) =>
  selectMastersState(state).error
